...
import com.esrakonya.contacsapp.ui.widget.SwipeToDeleteContainer
...
fun PersonListRow(
    ...
    SwipeToDeleteContainer(
        item = selectedPerson,
        onDelete = { person ->
            Log.d("PersonScreen","Silme işlemi tetiklendi: ${person.personID}")
            viewModel.deletePersonData(person.personID)
        }
    ) {
        Card(
            modifier = Modifier
